...
export const icons: Record<string, string> = {
  ...
  connect:
    '<path d="M9 2v6"/><path d="M15 2v6"/><path d="M8 8h8a1 1 0 0 1 1 1v3a5 5 0 0 1-10 0V9a1 1 0 0 1 1-1Z"/><path d="M12 17v5"/>',
  ...
  // Pulse line — "is this plugin alive?" health probe.
